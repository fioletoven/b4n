...
impl Display for KeyCommand {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            KeyCommand::NavigateNext => f.write_str("navigate.next")?,
            KeyCommand::NavigatePrevious => f.write_str("navigate.previous")?,
...
impl FromStr for KeyCommand {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "navigate.next" => Ok(KeyCommand::NavigateNext),
            "navigate.previous" => Ok(KeyCommand::NavigatePrevious),
