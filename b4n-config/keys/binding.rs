...
define_key_commands! {
    ...
    pub enum KeyCommand {
        ...
        EditCopy => "edit.copy" @ "Ctrl+C",
        EditCut => "edit.cut" @ "Ctrl+X",
        EditDeleteLine => "edit.delete-line" @ "Ctrl+D",
        EditMoveDown => "edit.move-down" @ "Ctrl+Down",
        EditMoveUp => "edit.move-up" @ "Ctrl+Up",
        EditPaste => "edit.paste" @ "Ctrl+V",
        ...
        TransferFrom => "transfer.from" @ "Ctrl+T",
