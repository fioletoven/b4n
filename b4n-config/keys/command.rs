...
impl Display for KeyCommand {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            KeyCommand::NavigateSelectAll => f.write_str("navigate.select-all")?,
            ...
            KeyCommand::InvolvedObjectShow => f.write_str("involved-object.show")?,
            ...
            KeyCommand::YamlEdit => f.write_str("yaml.edit")?,
            KeyCommand::YamlCreate => f.write_str("yaml.create")?,
...
impl FromStr for KeyCommand {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "navigate.select-all" => Ok(KeyCommand::NavigateSelectAll),
            ...
            "involved-object.show" => Ok(KeyCommand::InvolvedObjectShow),
            ...
            "yaml.edit" => Ok(KeyCommand::YamlEdit),
            "yaml.create" => Ok(KeyCommand::YamlCreate),
